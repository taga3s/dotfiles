...
link_config nvim/lua/config/lazy.lua "$XDG_CONFIG_HOME/nvim/lua/config/lazy.lua"
link_config nvim/lua/plugins/init.lua "$XDG_CONFIG_HOME/nvim/lua/plugins/init.lua"
link_config nvim/lua/plugins/nvim-tree.lua "$XDG_CONFIG_HOME/nvim/lua/plugins/nvim-tree.lua"
